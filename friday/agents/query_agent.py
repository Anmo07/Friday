...
from models.ollama_runtime import OllamaModelUnavailableError
...
async def process_query_single_agent(query: str) -> QueryResponse:
    ...
    try:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", "You are Friday, an autonomous real-time news intelligence and fake news detection platform. "
        ...
        return response
    except (OllamaModelUnavailableError, Exception) as e:
