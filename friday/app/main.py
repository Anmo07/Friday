"""Friday — Application entry point.
...
async def lifespan(app: FastAPI):
    ...
    logger.info(f"Friday started in {total_elapsed:.2f}s (models loading in background)")
...
async def root_redirect():
    ...
    return {"status": "ok", "service": "Friday Backend", "docs_url": "/docs"}
