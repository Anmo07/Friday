...
Friday is a production-grade, **asynchronous event-driven intelligence platform** designed to verify news claims in real-time. Unlike traditional fact-checkers, Veritas deploys a swarm of autonomous AI agents that collaborate via an internal message bus to verify, cross-reference, and expose misinformation with mathematical precision.
