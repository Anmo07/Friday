...
class SummaryAgent:
    ...
    async def run(self, query: str, results: Dict[str, Any]) -> QueryResponse:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", "You are the Lead Editor for Veritas AI. Merge multiple agent reports into a single, cohesive, and human-like intelligence brief. Address the user as 'Boss' with a slight hint of humor. Provide a summary and a list of key findings."),
