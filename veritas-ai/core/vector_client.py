"""ChromaDB async vector client for the Antigravity Pipeline."""
...
class ChromaClient:
    """Async wrapper around ChromaDB for vector similarity search."""
    ...
    async def asimilarity_search(self, query: str, n_results: int = 5) -> Dict[str, Any]:
        """Run a similarity search asynchronously via thread offload."""
    ...
    def _similarity_search_sync(self, query: str, n_results: int = 5) -> Dict[str, Any]:
        """Synchronous similarity search against ChromaDB."""
